...
def build_sheet3(wb):
    ...
    items = [
        ...
        (R_HV1,     "성분1 잠열 [kJ/kg]",
         f"=VLOOKUP({I}!B22,{D}!A13:E18,3,FALSE)",
         "kJ/kg", "2_물성DB A13:E18 참조", False),
        (R_HV2,     "성분2 잠열 [kJ/kg]",
         f"=VLOOKUP({I}!B23,{D}!A13:E18,3,FALSE)",
         "kJ/kg", "", False),
        (R_HV3,     "성분3 잠열 [kJ/kg]",
         f"=VLOOKUP({I}!B24,{D}!A13:E18,3,FALSE)",
         "kJ/kg", "", False),
        (R_HV_AVG,  "평균 잠열 ΔHvap [kJ/kg]",
         f"=(B{R_HV1}*{I}!C22+B{R_HV2}*{I}!C23+B{R_HV3}*{I}!C24)"
         f"/({I}!C22+{I}!C23+{I}!C24)",
         "kJ/kg", "몰분율 가중평균", False),
        (R_RHO1,    "성분1 액밀도 [kg/m³]",
         f"=VLOOKUP({I}!B22,{D}!A13:E18,4,FALSE)",
         "kg/m³", "", False),
        (R_RHO2,    "성분2 액밀도 [kg/m³]",
         f"=VLOOKUP({I}!B23,{D}!A13:E18,4,FALSE)",
         "kg/m³", "", False),
        (R_RHO3,    "성분3 액밀도 [kg/m³]",
         f"=VLOOKUP({I}!B24,{D}!A13:E18,4,FALSE)",
         "kg/m³", "", False),
        (R_RHO_AVG, "평균 밀도 ρ [kg/m³]",
         f"=(B{R_RHO1}*{I}!C22+B{R_RHO2}*{I}!C23+B{R_RHO3}*{I}!C24)"
         f"/({I}!C22+{I}!C23+{I}!C24)",
         "kg/m³", "몰분율 가중평균", False),
        (R_TBP1,    "성분1 비등점 [℃]",
         f"=VLOOKUP({I}!B22,{D}!A13:E18,5,FALSE)",
         "℃", "", False),
        (R_TBP2,    "성분2 비등점 [℃]",
         f"=VLOOKUP({I}!B23,{D}!A13:E18,5,FALSE)",
         "℃", "", False),
        (R_TBP3,    "성분3 비등점 [℃]",
         f"=VLOOKUP({I}!B24,{D}!A13:E18,5,FALSE)",
         "℃", "", False),
        (R_TBP_AVG, "평균 비등점 T_bp [℃]",
         f"=(B{R_TBP1}*{I}!C22+B{R_TBP2}*{I}!C23+B{R_TBP3}*{I}!C24)"
         f"/({I}!C22+{I}!C23+{I}!C24)",
         "℃", "몰분율 가중평균", False),
